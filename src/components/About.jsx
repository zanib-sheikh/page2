...
<div className="relative w-full  pt-16 bg-gradient-to-bl  from-[#706FAB] to-[#8887c4] min-h-screen">
  ...
  <div className="w-full md:w-1/2 text-left order-1 md:order-none">
    ...
    <p className="text-white font-montserrat leading-relaxed text-lg pr-12 md:text-base">
  ...
  <div className="relative w-full tansition-transform px-4 duration-300 hover:scale-105 md:w-1/2 order-2 md:order-none">
...
<div className="flex flex-col md:flex-row justify-center font-montserrat bg-white items-center gap-6 px-4 py-16">
      {/* Mission Card */}
      <div className="bg-[#706FAB] text-white  shadow-lg px-6 py-8 text-center relative w-80">
      ...
      {/* Vision Card */}
      <div className="bg-[#706FAB] text-white  shadow-lg px-6 py-6 text-center relative w-80">
        <div className="absolute -top-6 left-12 transform -translate-x-1/2 bg-[#BC99C3] w-12 h-12 rounded-full flex items-center justify-center">
      ...
      {/* Goal Card */}
      <div className="bg-[#706FAB] text-white  shadow-lg px-6 py-9  text-center relative w-80">
        <div className="absolute -top-6 left-12 transform -translate-x-1/2 bg-[#BC99C3] w-12 h-12 rounded-full flex items-center justify-center">
