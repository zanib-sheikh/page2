...
>
  ...
  <div className="bg-white items-center font-montserrat justify-between w-full mt-2 mb-16 mx-auto p-1 ">
      {/* Eligibility Section */}
    ...
    />
    <h2 className="text-2xl md:text-3xl mb-9 font-bold">
      <span className="text-black">Eligibility </span>  
      <span className="text-green-600 underline">Status</span> 
    </h2>
  ...
  <div className="relative w-full md:w-1/2 flex items-center justify-center tansition-transform duration-300 hover:scale-105 order-2 md:order-none mt-8 md:mt-8">
    <img 
      src={Fala1}
      alt="Student Testimonial" 
      className="w-64  md:w-[300px]  h-auto"
    />
    
    {/* Overlapping Square */}
    <div className="absolute top-4 md:top-10 left-4 md:left-9 border-[10px] md:border-[12px] border-black w-[220px] md:w-[220px] h-[220px] md:h-[240px]"></div>
  </div></div>
  ...
  <div className="relative w-full md:w-1/2 flex items-center justify-center tansition-transform duration-300 hover:scale-105 order-2 md:order-none mt-8 md:mt-8">
    <img 
      src={Fala2}
      alt="Student Testimonial" 
      className="w-64  md:w-[300px] pl-42 h-auto"
    />
    
    {/* Overlapping Square */}
    <div className="absolute top-4 md:top-10 left-4 md:left-96 border-[10px] md:border-[12px] border-black w-[220px] md:w-[220px] h-[220px] md:h-[240px]"></div>
  </div>
  ...
  {/* Right Section (Image with Overlapping Square - Appears After Text on Mobile) */}
  <div className="relative w-full md:w-1/2 flex items-center mt-8 justify-center tansition-transform duration-300 hover:scale-105 order-2 md:order-none md:mt-8">
    <img 
      src={Fala3}
      alt="Student Testimonial" 
      className="w-64 md:w-[300px] pl-9 h-auto"
    />
    
    {/* Overlapping Square */}
    <div className="absolute top-4 md:top-10 left-4 md:left-16 border-[10px] md:border-[12px] border-black w-[220px] md:w-[220px] h-[220px] md:h-[240px]"></div>
  </div></div>
