...
>
  ...
  <div className="flex flex-wrap justify-center bg-white gap-20 font-montserrat  p-4">
      {/* Card 1 */}
      <div className="w-[300px] h-[410px] bg-white tansition-transform duration-300 hover:scale-105 shadow-lg shadow-gray-400 mt-8 rounded-xl overflow-hidden">
        <img src={Ourimpact1} alt="Gabon" className="w-[300px] h-[220px] object-cover " />
        ...
        <div className="bg-purple-400 h-[50px] text-center justify-center text-xl text-white py-2 font-semibold">GABON</div>
      </div>

      {/* Card 2 */}
      <div className="w-[300px] h-[410px] bg-white tansition-transform duration-300 hover:scale-105 shadow-lg shadow-gray-400 mt-8 rounded-xl overflow-hidden">
        <img src={Ourimpact2} alt="Congo" className="w-[300px] h-[220px] object-cover" />
        ...
        <div className="bg-purple-400 h-[50px] text-center justify-center text-xl text-white py-2 font-semibold">CONGO BRAZZAVILLE</div>
      </div>

      {/* Card 3 */}
      <div className="w-[300px] h-[410px] bg-white  tansition-transform duration-300 hover:scale-105 shadow-lg shadow-gray-400 mt-8 rounded-xl overflow-hidden">
        <img src={Ourimpact1} alt="Angola" className="w-[300px] h-[220px] object-cover" />
        <div className="bg-[#706FAB] text-white h-[140px] px-3 py-2">
          <h3 className="font-semibold text-lg">IMPACT REPORT FORM ANGOLA</h3>
          <p>Shaping Possibilities Ambassador Israel Majaks Youth Mentorship Program in South Sudan</p>
        </div>
        <div className="bg-purple-400 h-[50px] text-center justify-center text-xl text-white py-2 font-semibold">ANGOLA</div>
      </div>
    </div>
    ...
    <div className="flex flex-wrap justify-center bg-white gap-20 font-montserrat mb-16 p-4">
      {/* Card 1 */}
      <div className="w-[300px] h-[410px] bg-white tansition-transform duration-300 hover:scale-105 shadow-lg shadow-gray-400 mt-8 rounded-xl overflow-hidden">
        <img src={Ourimpact1} alt="Gabon" className="w-[300px] h-[220px] object-cover" />
        <div className="bg-[#706FAB] text-white p-3 h-[140px] px-3 py-2">
      ...
      {/* Card 2 */}
      <div className="w-[300px] h-[410px] bg-white  tansition-transform duration-300 hover:scale-105shadow-lg shadow-gray-400 mt-8 rounded-xl overflow-hidden">
        <img src={Ourimpact2} alt="Congo" className="w-[300px] h-[220px] object-cover" />
        <div className="bg-[#706FAB] text-white h-[140px] px-3 py-2 ">
          <h3 className="font-semibold text-lg">QUALITY EDUCATION – CONGO BRAZZAVILLE</h3>
          <p>Shaping Possibilities Ambassador Israel Majaks Youth Mentorship Program in South Sudan</p>
